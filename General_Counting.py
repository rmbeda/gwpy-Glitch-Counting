...
# This script will create a directory '{year in 3rd millenium}/{month #}/{day #}'
...
# 1) Uncomment lines 646, 648, and 660 and comment out lines 647, 649, and 661, 
...
#    obtained using this script, simply set 'skip_load' to 'True' in line 622
#    before running.

# Additionally, edit code from here through line 629, and within the range
# of lines 643-673, to tweak values such as relevant start and end times, 
...
skip_load = False # Set to 'True' if you want to use the secondary intermediate files
...
skip_load_direct = 'Wind_Thresh_2'
